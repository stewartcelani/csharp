    ...
    public static async Task SeedDataAsync(this WebApplication app)
    {
        ...
        var cities = new List<City>
        {
            new()
            {
                ...
                Name = "Adelaide",
                Description =
                    "Adelaide is the capital city of South Australia, the state's largest city and the fifth-most populous city of Australia. 'Adelaide' may refer to either Greater Adelaide or the Adelaide city centre. The demonym Adelaidean is used to denote the city and the residents of Adelaide.",
            ...
            new()
            {
                ...
                PointsOfInterest = new List<PointOfInterest>
                {
                    ...
                    new()
                    {
                        ...
                        Name = "Phillip Island",
                        Description =
                            "Phillip Island is an Australian island about 125 km south-southeast of Melbourne, Victoria. The island is named after Governor Arthur Phillip, the first Governor of New South Wales, by explorer and seaman George Bass, who sailed in an whaleboat, arriving from Sydney on 5 January 1798."
                    }
                }
            },
            new()
