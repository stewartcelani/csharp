...
public class ApplicationDbContext : DbContext
{
    ...
    public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options, ILoggerAdapter<ApplicationDbContext> logger, DatabaseSettings databaseSettings) : base(options)
    {
        _logger = logger;
        _databaseSettings = databaseSettings;
    }
