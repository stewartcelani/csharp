...
using Databases.EFCore.Sqlite.Database;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Sqlite;
using Databases.EFCore.Sqlite.Models;
using Databases.EFCore.Sqlite.Types;

namespace Databases.EFCore.Sqlite.Database;
