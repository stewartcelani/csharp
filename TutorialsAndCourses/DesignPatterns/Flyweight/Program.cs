...
characterObject = characterFactory.GetCharacter(aBunchOfCharacters[2]); // Will be reused
characterObject.Draw("Times New Roman", 16);

characterObject = characterFactory.GetCharacter(aBunchOfCharacters[3]); // Will be reused
